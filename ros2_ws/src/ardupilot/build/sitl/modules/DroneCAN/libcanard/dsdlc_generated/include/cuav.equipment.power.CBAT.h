...
static inline bool _cuav_equipment_power_CBAT_decode(const CanardRxTransfer* transfer, uint32_t* bit_ofs, struct cuav_equipment_power_CBAT* msg, bool tao);
...
/*
 decode cuav_equipment_power_CBAT, return true on failure, false on success
*/
bool _cuav_equipment_power_CBAT_decode(const CanardRxTransfer* transfer, uint32_t* bit_ofs, struct cuav_equipment_power_CBAT* msg, bool tao) {
    (void)transfer;
    (void)bit_ofs;
    (void)msg;
    (void)tao;
