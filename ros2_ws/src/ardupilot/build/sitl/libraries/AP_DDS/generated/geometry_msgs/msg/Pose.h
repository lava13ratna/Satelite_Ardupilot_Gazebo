...
struct ucdrBuffer;
bool geometry_msgs_msg_Pose_serialize_topic(struct ucdrBuffer* writer, const geometry_msgs_msg_Pose* topic);
bool geometry_msgs_msg_Pose_deserialize_topic(struct ucdrBuffer* reader, geometry_msgs_msg_Pose* topic);
